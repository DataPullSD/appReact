...
public class User {
    ...
    public User(Long idS, Long userId, String phoneNumber, String firstName, String lastName, String gender, String currentCity, String currentCountry, String hometownCity, String hometownCountry, String relationshipStatus, String workplace, String email, String currentDepartment, String currentRegion) {
        this.idS = idS;
        this.userId = userId;
